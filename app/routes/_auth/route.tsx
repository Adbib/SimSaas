...
export default function Auth() {
  ...
  return (
    <main className="w-full flex">
      <div className="relative flex-1 hidden items-center justify-center h-screen bg-indigo-900 lg:flex">
      ...
      <div className="flex-1 flex items-center justify-center h-screen">
        <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
          ...
          {/* <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
            <div>
              <label aria-controls="dd" className="font-medium">Name</label>
              <input
                type="text"
                required
  ...
  function Imgs() {
    return (
      <div className="flex items-center -space-x-2 overflow-hidden my-5">
        <img
          alt=""
